...
- **More than two groups** → ANOVA (future section, or consult Guild)
- **Confounding variables** → ANCOVA or regression (Guild consultation)
- **Repeated measures** → Mixed models (Guild consultation)
