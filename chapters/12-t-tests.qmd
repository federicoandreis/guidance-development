...
- **Comparing >2 groups**: Use ANOVA (beyond this guide, seek specialist support)
...
**If violated**: Don't use standard t-test. Seek specialist support for appropriate method.
...
**When to escalate**: If you're unsure whether assumptions are met, or how to handle violations, seek specialist support. Getting this wrong invalidates your results.
:::
...
- **More than two groups** → ANOVA (future section, or seek specialist support)
- **Confounding variables** → ANCOVA or regression (seek specialist support)
- **Repeated measures** → Mixed models (seek specialist support)
...
7. **When in doubt, seek specialist support**: Especially for assumption violations or complex designs
