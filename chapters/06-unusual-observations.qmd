...
- Use **robust regression** methods (seek specialist support)
...
If you're considering these approaches, seek specialist support — there's usually a better option.
:::
...
**When to escalate**: If you're doing multivariate modeling (regression, clustering, PCA) and suspect influential observations, seek specialist support. Multivariate outlier diagnostics require specialist interpretation.
