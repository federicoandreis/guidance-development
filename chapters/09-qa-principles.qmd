...
After reading this chapter, you will understand the five questions that structure CQC's Quantitative Analytics and Statistics Quality Assurance (QASQA) Framework, know the roles and responsibilities involved in analytical quality assurance, and be able to apply proportionate QA thinking — scaling documentation and review to the risk and complexity of your analysis.
...
- Builds confidence in analysis across the organisation
...
**Why it matters**: Analysing the wrong unit or including duplicates gives nonsensical results.
...
**Credibility**: When analysis is questioned, can CQC show its working and explain its reasoning?

**Defensibility**: Can analytical choices be defended if challenged by providers, in court, or in media?

**Consistency**: Are consistent standards being applied across teams and analyses?

**Learning**: Can the organisation learn from what works and what doesn't if it doesn't document it?
...
## ⚙️ Overthinking: When to Escalate to the Guild

The Quantitative Analytics and Statistics Guild (the Guild) community and your function's technical experts can help with complex or novel analytical challenges. Escalate when:
...
The Guild is a community space, not a delivery team. Use it strategically for genuine complexity. See @sec-getting-started for how to get help.

For formal review or complex cases: [Practice Lead for Quantitative Analytics and Statistics](mailto:federico.andreis@cqc.org.uk)
:::

::: {.callout-note icon=false}
## Related Approaches

- For data type verification (QA step 3 — variable definitions) → @sec-data-types
- For missing data assessment (QA pre-analysis checklist step 4) → @sec-missing-data-foundations
- For unusual observation investigation (QA pre-analysis checklist step 4) → @sec-unusual-observations
- For applying inference principles correctly (QA design and delivery questions) → @sec-statistical-inference
- For method-specific QA requirements and "before you start" checklists → each methods chapter (@sec-z-scoring through @sec-missing-data-handling)
- For help with genuinely complex analytical challenges → the Guild Quant Clinic (@sec-getting-started)
:::
...
- **"When to seek specialist support" sections**: When to seek help beyond this guidance
...
8. **Escalate strategically**: Specialist support is for genuine complexity, novel methods, high stakes. Use it early in design, not after analysis complete.
