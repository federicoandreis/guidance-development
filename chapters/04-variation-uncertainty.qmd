...
After reading this chapter, you will be able to measure and describe spread across quantitative, ordinal, and nominal data; understand when to prefer standard deviation over IQR, and CV over raw measures; and use visualisation to reveal distribution patterns that summary statistics alone can miss.
...
## ⚙️ Overthinking: Other Normalized Measures
...
**When to escalate**: If you're unsure which normalization is appropriate for your comparison, or if stakeholders are confused by normalized measures, raise it with the Quantitative Analytics and Statistics Guild (the Guild).
:::
