...
✅ **Special cause identification** despite trend  
✅ **Limitations of standard SPC** with unstable processes  
✅ **Operational context** interpretation (capacity issues)  
✅ **Alternative monitoring approaches** for trending data
...
| Item | Detail |
|------|--------|
| **Method** | SPC I-chart with trend analysis; linear regression for trend quantification |
| **QASQA question** | Q3: Analysis — is the SPC method appropriate for trending data?; Q4: Delivery & Communication — does the chart make the deterioration visible to stakeholders? |
| **Competencies** | A: Statistical analysis and methods; B: Analytical judgment; D: Communication of findings |
| **Data source** | Monthly ambulance handover delay rates (synthetic illustrative data) |
| **Key decisions** | I-chart chosen (single rate per month); standard limits calculated from baseline despite trend — limitations noted; trend analysis added as supplementary to standard SPC |
| **Assumptions** | Monthly data points independent; measurement definition consistent throughout; no structural change in data collection |
| **Limitations** | Standard SPC control limits less meaningful when process shows sustained trend; trend may not be linear long-term; single trust — cannot generalise |
| **Sensitivity** | Consistent with visual inspection; trend magnitude stable across different baseline period definitions |
| **Next steps** | Investigate operational root causes (winter pressures, capacity); consider detrended control chart or CUSUM for ongoing monitoring |
