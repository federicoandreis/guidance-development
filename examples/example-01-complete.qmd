...
**Competencies demonstrated**: A (Statistical analysis and methods); C (Data quality and governance); E (Quality assurance and reproducibility)
...
2. **Monitoring**: Band 6 practices (2 < z ≤ 3)
...
✅ Exploratory analysis and assumption checking  
✅ Z-score calculation and performance banding  
✅ Identification of practices for follow-up  
✅ Stakeholder-ready visualizations and reporting  
...
| **Key decisions** | Complete case analysis for missing data (5% excluded, documented); z ≥ 2 threshold for flagging; national mean and SD calculated from all providers with complete data |
