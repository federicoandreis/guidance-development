...
**Status**: ✅ Complete
**QASQA questions**: Q3 (Analysis); Q4 (Delivery & Communication)
...
if (max_run >= 8) {
  cat("\n✅ Rule 4 TRIGGERED: Process has shifted\n")
...
**Evidence**:
- ✅ Multiple points below baseline LCL
- ✅ Rule 4 triggered (12 consecutive below centre)
- ✅ Statistical significance (p < 0.001)
- ✅ Clinically significant reduction (~7 falls/month, 40%)
- ✅ Improvement sustained throughout 12-month post-intervention period
...
✅ Time-series visualization and data preparation  
✅ Baseline control chart with special cause handling  
✅ Control limit calculation (I-chart method)  
✅ Intervention effect detection using SPC rules  
✅ Statistical confirmation and sustainability assessment  
...
| Item | Detail |
|------|--------|
| **Method** | Statistical Process Control — I-chart |
| **QASQA question** | Q3: Analysis — was the method appropriate and correctly applied?; Q4: Delivery & Communication — does the chart communicate the finding clearly? |
| **Competencies** | A: Statistical analysis and methods; B: Analytical judgment; D: Communication of findings |
| **Data source** | Monthly falls counts (synthetic illustrative data — seed 42) |
| **Key decisions** | Baseline period months 1–12 used for control limits; month 7 (flu outbreak) excluded from limit calculation; I-chart chosen (one count per period) |
| **Assumptions** | Process stable in baseline period; flu outbreak is a known special cause unrelated to underlying care quality; post-intervention period is independent |
| **Limitations** | Single care home — cannot generalise; short post-intervention period (12 months) limits sustainability assessment; regression to the mean possible |
| **Sensitivity** | Results consistent with Rule 1 only and with Rules 1+4 applied |
| **Next steps** | Continue monitoring for at least 12 more months to confirm sustainability; triangulate with inspection findings and resident outcomes |
