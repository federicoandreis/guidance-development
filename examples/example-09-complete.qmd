...
**Status**: ✅ Complete
**QASQA questions**: Q2 (Design); Q3 (Analysis)
**Competencies demonstrated**: A (Statistical analysis and methods); B (Analytical judgment); D (Communication of findings)
...
These examples require R or Python. If you are not yet set up with a coding environment:

- **Microsoft Fabric**: CQC's primary analytics platform — contact your function's data engineer for access
- **RSS training**: Introductory R and Python courses available via CQC's learning platform
- **Quant Clinic**: Drop-in sessions for hands-on help with code and methods — see the [Guild Teams channel](https://teams.microsoft.com) for upcoming dates

Both R and Python versions are provided throughout. Use whichever you are more comfortable with.
:::
...
- Confounding by complexity: Complex residents → higher staffing AND higher ulcers
...
knitr::kable(correlation_results, 
             col.names = c("Method", "n", "r/ρ", "95% CI Lower", 
                          "95% CI Upper", "P-Value"),
...
**Next steps**: Investigate CH600 (high staffing, high ulcers); consider multivariate analysis controlling for multiple confounders (seek specialist support)
...
4. **Correlation ≠ causation**: Multiple explanations possible
...
## QA Documentation Record

| Item | Detail |
|------|--------|
| **Method** | Spearman's rank correlation (robust to outliers and non-normal distribution of pressure ulcer rates) |
| **QASQA question** | Q2: Design — is correlation appropriate for this thematic research question?; Q3: Analysis — were method choice and outlier handling documented? |
| **Competencies** | A: Statistical analysis and methods; B: Analytical judgment; D: Communication of findings |
| **Data source** | Nursing staff ratio and pressure ulcer rate per 1,000 resident-days (synthetic illustrative data, n=200 care homes) |
| **Key decisions** | Spearman chosen over Pearson (outlier present: CH600; pressure ulcer rates right-skewed); Pearson reported for comparison; CH600 investigated and retained (confirmed genuine outlier) |
| **Assumptions** | Each care home is an independent observation; nurse ratio is measured consistently across homes; pressure ulcer rates are reliably reported |
| **Limitations** | Cross-sectional — cannot establish causation or direction; resident complexity confounds the relationship; no adjustment for care home size, case-mix, or regional factors |
| **Sensitivity** | Excluding CH600 weakens but does not reverse the relationship (ρ = -0.38 vs -0.45); Pearson and Spearman give consistent direction |
| **Next steps** | Multivariate analysis with Guild support to control for resident complexity; triangulate with inspection narratives; consider longitudinal design |
| **Sign-off** | \_\_\_\_\_\_\_\_ (Analyst) \_\_\_\_\_\_\_\_ (Peer reviewer) \_\_\_\_\_\_\_\_ (Date) |
