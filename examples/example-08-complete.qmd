...
**150 local authorities × 12 quarters** = 1,800 observations:
...
✅ **Trend analysis** across multiple units  
✅ **Policy impact assessment** using interrupted time series  
✅ **Outlier detection** in panel data  
✅ **Rate standardization** for fair comparison  
✅ **System-wide change** interpretation
...
| Item | Detail |
|------|--------|
| **Method** | SPC with interrupted time series; DoLS application rates per 1,000 eligible population |
| **QASQA question** | Q3: Analysis — does the ITS method appropriately isolate the policy effect from pre-existing trend?; Q4: Delivery & Communication — are the trend and intervention effect communicated clearly? |
| **Competencies** | A: Statistical analysis and methods; B: Analytical judgment; D: Communication of findings |
| **Data source** | DoLS applications by local authority, quarterly (synthetic illustrative data) |
| **Key decisions** | Rates per 1,000 eligible population used (not raw counts); interrupted time series structure (pre/post Cheshire West ruling); outlier LAs investigated separately |
| **Assumptions** | Policy change date is correctly identified; population estimates are accurate; no concurrent confounding policy changes |
| **Limitations** | No individual-level data; ecological analysis only; local authority capacity and definitions may vary; 2014 Cheshire West ruling creates structural break |
| **Sensitivity** | Pre-trend and post-intervention slope estimates stable across model specification variants |
| **Next steps** | Validate outlier LAs with operational knowledge; consider multilevel model with Guild support; monitor for regression to mean in initially high LAs |
