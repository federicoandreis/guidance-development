...
| Item | Detail |
|------|--------|
| **Method** | Paired t-test (before/after within same care homes) |
| **QASQA question** | Q2: Design — is the paired design appropriate for this evaluation?; Q3: Analysis — were assumptions checked and correctly handled? |
| **Competencies** | A: Statistical analysis and methods; B: Analytical judgment; E: Quality assurance and reproducibility |
| **Data source** | Medication error rates for 10 pilot care homes, 6 months before/after (synthetic illustrative data) |
| **Key decisions** | Paired test (same homes measured twice — preserves within-home correlation); Shapiro-Wilk on differences (not raw values) confirmed normality |
| **Assumptions** | Same homes measured at both time points; no major confounding changes (staffing, case-mix) during the 6-month period; differences approximately normally distributed |
| **Limitations** | No control group — cannot rule out temporal trends (regression to mean, seasonal effects); small sample (n=10) limits generalisability; 6-month follow-up may not capture sustainability |
| **Sensitivity** | Wilcoxon signed-rank gives consistent result (non-parametric check) |
| **Next steps** | Wider rollout with control group design; investigate CH03 outlier; plan 12-month follow-up evaluation |
